...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Your queries our Response!😊</h3>
		<!--<form action="https://formsubmit.co/ea48154c1bfa7eede918fe3292723775" method="POST">-->  <!--el/yawitu-->
	    <!--<form action="https://formsubmit.co/el/7e2ca2c3a755f430ddf5d1b12b852065" method="POST">-->     <!--el/mozudi-->
...
<b>Description</b>  <textarea name="description" class="form-control" rows="6" cols="50" id="description"  placeholder="Description" required=""></textarea> 
			...
			<p style="width: 350px;">
			<!--<form action="https://formsubmit.co/rakshithonnavar20@gmail.com" method="POST">-->
